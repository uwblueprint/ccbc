...
/**
 * This is a model for the ForgotPasswordEmailModal component's props
 */
...
const ForgotPasswordEmailModal = ({
  isOpen,
  onClose,
}: ForgotPasswordEmailModalProps): React.ReactElement => {
  return (
    <Modal isOpen={isOpen} onClose={onClose} isCentered>
      ...
      >
        ...
        <ModalBody ml="82px" mt="15px" width="444px">
          <Text fontSize="18px">
            We have sent you further instructions to reset your password
          </Text>
